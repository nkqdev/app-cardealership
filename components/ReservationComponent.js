...
//           <Button title='Close' color='#9FE2BF' onPress={() => this.props.onPressClose()} />
//         </View>
//       );
//     }
// }
    ...
    return (
      <ScrollView>
        ...
        <View style={{flexDirection:'column'}}>
          <Button title='Reserve' buttonStyle={{backgroundColor:'#9FE2BF'}} onPress={() => this.handleReservation()} />
        </View>
